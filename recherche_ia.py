...
# --- CORRECTION : Récupération sécurisée de la clé ---
# On tente d'abord de lire le secret Streamlit, sinon la variable d'environnement
...
def nettoyer_reponse(texte):
    ...
    for ligne in lignes:
        ...
        # --- CORRECTION : Suppression de l'accent pour correspondre à la variable ---
...
def rechercher_sur_le_web(historique, image_file=None):
    ...
    consignes_systeme = (
        ...
        f"RÈGLE DE VOIX : N'utilise aucun symbole de mise en forme. Écris uniquement des phrases en texte brut fluide, naturel et sans répétition. "
    ...
    try:
        # Note : gemini-2.0-flash est plus stable que 2.5 actuellement
